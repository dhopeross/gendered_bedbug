...
#Open SFTP Session to FITH FTP, change directory to /tf2-maps/tf2-fight-club-and-payload-maps, copy bsp files -this will upload to the main TF2 server
...
"cd /tf2-maps/tf2-fight-club-and-payload-maps/" `
